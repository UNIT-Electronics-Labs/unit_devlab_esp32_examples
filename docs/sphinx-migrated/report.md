# Cómo generar un reporte de error

Esta guía explica cómo generar un reporte de error usando repositorios de GitHub.
...
El equipo de desarrollo o los mantenedores revisarán el issue y tomarán las acciones necesarias para atenderlo.
